...
def init():
    System.Size(80, 20)                                                                                                                                                                                                                                                                   ,System.Title(".B.r.u.t.e. .-. .b.y. .b.i.l.l.y.t.h.e.g.o.a.t.3.5.6.".replace('.',''))
    Cursor.HideCursor()
    System.Title(".gg/encrypted")
...
def main():
    ...
    ip = input(stage(f"Enter Victims IP {purple}->{fluo2} ", '?'))
    print()
    ...
    try:
        ...
        brute.stop()
        print(stage(f"Attack stopped. {fluo2}{ip}{cport}{white} was attacked with {fluo}{round(brute.total, 1)} {white}Gb.", '.'))
    print('\n')
    sleep(1)
